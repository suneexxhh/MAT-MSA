...
#   日志文件：logs/mscm_MAP_NAME_L3_c4_seed1.log
#
...
#   日志文件：logs/mscm_MAP_NAME_L3_c4_seed42.log
...
EOF
    ...
    echo "Updated: train_smac_${map}_custom.sh (with logging)"
done

echo ""
echo "All custom scripts updated with logging support!"
